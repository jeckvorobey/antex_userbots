# Cross-group Exchange Diversity

## Purpose

Coordinate participant and topic diversity across explicitly identified AI assistants in multiple Telegram groups using persisted scheduling metadata.
